# Driver to test the optimizers on the [sphere] function.
...
res = ES_vanilla_gradient(F, alpha=5e-4, sigma=1, theta_0=initial_pt, num_samples = 50, time_steps = 200)
...
plt.title("Sphere function (100 dimensional)", fontsize=20)
plt.tight_layout()
