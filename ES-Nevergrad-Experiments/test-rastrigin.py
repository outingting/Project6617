# Driver to test the optimizers on the [rastrigin] function.
...
res = ES_vanilla_gradient(F, alpha=1e-4, sigma=1, theta_0=initial_pt, num_samples = 25, time_steps = 400)
...
plt.title("Rastrigin function (100 dimensional)", fontsize=20)
plt.tight_layout()

# plt.show()
plt.savefig('test_rastrigin.png')
