...
def ES_vanilla_gradient(F, alpha, sigma, theta_0, num_samples, time_steps):
    count = 0
    lst_evals = []
    lst_f = []
    d = theta_0.shape[0]
...
def ES_Hessian(F, alpha, sigma, theta_0, num_samples, time_steps, p = 1, H_lambda = 0):   
    count = 0
    lst_evals = []
    lst_f = [] 
    d = theta_0.shape[0]
...
def Hess_Aware(F, alpha, sigma, theta_0, num_samples, time_steps, p = 1, H_lambda = 0):
	count = 0
	lst_evals = []
	lst_f = [] 
	d = theta_0.shape[0]
...
def LP_Hessian(F, alpha, sigma, theta_0, num_samples, time_steps):
	count = 0
	lst_evals = []
	lst_f = [] 
	d = theta_0.shape[0]
...
def LP_Hessian_structured(F, alpha, sigma, theta_0, num_samples, time_steps, H_lambda = 1e-6):
	count = 0
	lst_evals = []
	lst_f = [] 
	d = theta_0.shape[0]
